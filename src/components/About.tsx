        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
          <div className="order-2 md:order-1 animate-slide-in">
            <p className="text-lg mb-4">
              Hi, I'm Pratiksha Kshirsagar — a passionate MERN Stack Developer focused on crafting web applications
              that solve real-world problems and deliver seamless user experiences.
              With strong foundations in both frontend and backend technologies,
